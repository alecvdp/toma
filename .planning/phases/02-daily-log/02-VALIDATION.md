...
| 02-02-01 | 02 | 2 | LOG-01..06, CAT-10 | regression | `python -m pytest tests/ -x -q` | yes | pending |
...
- [x] `tests/test_log_service.py` -- stubs for LOG-01 through LOG-06, CAT-10
- [x] `tests/test_db.py` -- extend with daily_logs schema test
- [x] Existing `conftest.py` test_db fixture is sufficient
